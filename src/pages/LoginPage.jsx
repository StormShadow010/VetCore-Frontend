    ...
    <label style={{ display: "flex", flexDirection: "column", gap: 5 }}>
      <span
        style={{
          fontSize: 12,
          fontWeight: 600,
          color: error ? "var(--red)" : "var(--ink-soft)",
        }}
      >
        {label}
      </span>
...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (!form.username.trim())
      newErrors.username = "El usuario o email es obligatorio";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 400 }}>
          ...
          <p style={{ color: "var(--muted)", fontSize: 14, lineHeight: 1.6 }}>
            Mascotas, citas, consultas, medicamentos y facturación en un solo
            sistema.
          </p>
          <div
            style={{
          ...
          >
            {[
              ["🐾", "Registro completo de pacientes y propietarios"],
              ["📅", "Agenda y control de citas médicas"],
              ["💊", "Inventario de medicamentos en tiempo real"],
            ].map(([icon, text]) => (
              <div
                key={icon}
                style={{
      ...
      >
        <div
          style={{ width: "100%", maxWidth: 360, animation: "fadeIn .3s ease" }}
        >
          ...
          >
            ...
            {[
              ...
              <button
                key={u}
                onClick={() => setForm({ username: u, password: "" })}
                style={{
                  display: "flex",
